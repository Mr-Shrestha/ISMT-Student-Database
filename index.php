...
<div class="row">
	...
	<div class="col-sm-6">
		<div class="page-header"><h3>Quick Links</h3></div>
			<ul class="list-group">
			    <li class="list-group-item list-group-item-info"><h4><a href="https://ismt.edu.np"><strong>ISMT College</strong></a></h4></li>
			    <li class="list-group-item list-group-item-info"><h4><a href="https://ismt.edu.np/programs/btec-hnd-in-computing-leading-to-bsc-it"><strong>Department of Information Technology</strong></a></h4></li>
			    <li class="list-group-item list-group-item-info"><h4><a href="https://ismt.edu.np/contact"><strong>ISMT WebMail for staffs and students</strong></a></h4></li>
			</ul>
	</div>
</div>
<?php
