...
<div class="container">
	<header class="header text-center">
		...
		<center>
		<a href="https://ismt.edu.np/"><img src="../images/logo.jpg" height="100px" width="150px" style="vertical-align: middle;"></a>
		</center>
	</header><br /><br />
</div>
	      ...
	      <ul class="nav navbar-nav">   
	   		<li class="dropdown">
				...
				<li class="dropdown">
	   			...
	   			<ul class="dropdown-menu">
	   				<li class="<?= ($activePage == 'teaching') ? 'active':''; ?>"><a href="https://ismt.edu.np/faculty-staff/committees">Teaching Staffs</a></li>
	   				<li class="<?= ($activePage == 'nonteaching') ? 'active':''; ?>"><a href="https://ismt.edu.np/faculty-staff/committees">Non Teaching Staffs</a></li>
	   			</ul>
				</li>
				...
				<li class="dropdown">
	   			...
	   			<ul class="dropdown-menu">
	   				<li class="<?= ($activePage == 'cengineering') ? 'active':''; ?>"><a href="https://ismt.edu.np/students/forms">Register</a></li>
